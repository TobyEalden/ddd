...
export default function Sidebar() {
  return (
    <div className="bg-paper flex flex-col px-1 items-center">
      ...
      <SidebarButton iconName="fad fa-router" label="device descriptors" route="/device" />
      ...
      <SidebarButton iconName="fad fa-user-plus" label="add actor" />
    </div>
  );
}
