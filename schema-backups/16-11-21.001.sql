...
ALTER TABLE ONLY public.site DROP CONSTRAINT site_owner_id_fkey;
ALTER TABLE ONLY public.site DROP CONSTRAINT site_organisation_id_fkey;
...
--
-- Name: connection_type; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.connection_type OWNER TO supabase_admin;
...
CREATE VIEW public.inherited_firmware_binding AS
 SELECT firmware.id,
    firmware.name,
    firmware.payload_url AS payload_number,
...
--
-- Name: site_type; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.site_type OWNER TO supabase_admin;
...
--
-- Name: connection_type connection_type_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: site_type site_type_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: site site_connection_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.site
    ADD CONSTRAINT site_connection_type_id_fkey FOREIGN KEY (connection_type_id) REFERENCES public.connection_type(id);


--
-- Name: site site_organisation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.site
    ADD CONSTRAINT site_organisation_id_fkey FOREIGN KEY (organisation_id) REFERENCES public.organisation(id);


--
-- Name: site site_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.site
    ADD CONSTRAINT site_owner_id_fkey FOREIGN KEY (owner_id) REFERENCES public.profile(user_id);


--
-- Name: site site_site_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.site
    ADD CONSTRAINT site_site_type_id_fkey FOREIGN KEY (site_type_id) REFERENCES public.site_type(id);
...
--
-- Name: TABLE connection_type; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.connection_type TO postgres;
GRANT ALL ON TABLE public.connection_type TO anon;
GRANT ALL ON TABLE public.connection_type TO authenticated;
GRANT ALL ON TABLE public.connection_type TO service_role;
...
--
-- Name: TABLE site_type; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.site_type TO postgres;
GRANT ALL ON TABLE public.site_type TO anon;
GRANT ALL ON TABLE public.site_type TO authenticated;
GRANT ALL ON TABLE public.site_type TO service_role;
