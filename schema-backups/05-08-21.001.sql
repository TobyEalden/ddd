...
ALTER TABLE ONLY public.hierarchy DROP CONSTRAINT hierarchy_parent_id_fkey;
ALTER TABLE ONLY public.hierarchy DROP CONSTRAINT hierarchy_descendant_id_fkey;
ALTER TABLE ONLY public.hierarchy DROP CONSTRAINT hierarchy_ancestor_id_fkey;
...
--
-- Name: hierarchy; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.hierarchy OWNER TO supabase_admin;
...
--
-- Name: hierarchy hierarchy_ancestor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.hierarchy
    ADD CONSTRAINT hierarchy_ancestor_id_fkey FOREIGN KEY (ancestor_id) REFERENCES public.actor(id);


--
-- Name: hierarchy hierarchy_descendant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.hierarchy
    ADD CONSTRAINT hierarchy_descendant_id_fkey FOREIGN KEY (descendant_id) REFERENCES public.actor(id);


--
-- Name: hierarchy hierarchy_parent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: supabase_admin
--

ALTER TABLE ONLY public.hierarchy
    ADD CONSTRAINT hierarchy_parent_id_fkey FOREIGN KEY (parent_id) REFERENCES public.actor(id);
...
--
-- Name: TABLE hierarchy; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.hierarchy TO postgres;
